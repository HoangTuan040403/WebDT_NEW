...
namespace DoAnQuanLyTapHoa.Controllers
{
    public class ChiTietDonHangsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaCTDH,MaSP,MaDH,DonGia,SoLuong,TongTienSP")] ChiTietDonHang chiTietDonHang)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaCTDH,MaSP,MaDH,DonGia,SoLuong,TongTienSP")] ChiTietDonHang chiTietDonHang)
        {
            if (ModelState.IsValid)
            {
