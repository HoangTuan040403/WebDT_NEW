...
namespace DoAnQuanLyTapHoa.Controllers
{
    public class NhaCungCapsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaNCC,TenNCC,SoDienThoaiNCC,DiaChi")] NhaCungCap nhaCungCap)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaNCC,TenNCC,SoDienThoaiNCC,DiaChi")] NhaCungCap nhaCungCap)
        {
            if (ModelState.IsValid)
            {
